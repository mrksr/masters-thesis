    ...
    \begin{titlepage}%
        ...
        \parbox{1.2\linewidth}{
            \begin{tabular}[c]{@{}l@{}r@{}}
                \parbox[b][][b]{0.35\linewidth}{
                    \centering
                    \includegraphics[height=\TitleLogoHeight,width=\linewidth,keepaspectratio]{\FirstUniversityLogo}
                } &
        ...
        \parbox{1.2\linewidth}{
            \begin{tabular}[c]{@{}l@{}r@{}}
                \parbox[b][][b]{0.35\linewidth}{%
                    \centering
                    \includegraphics[height=\TitleLogoHeight,width=\linewidth,keepaspectratio]{\SecondUniversityLogo}
                } &
                \parbox[b][\TitleLogoHeight][c]{0.65\linewidth}{%
                    \raggedleft
        ...
        \parbox{1.2\linewidth}{
            \begin{tabular}[c]{@{}l@{}r@{}}
                \parbox[b][][b]{0.35\linewidth}{%
                    \centering
                    \includegraphics[height=\TitleLogoHeight,width=\linewidth,keepaspectratio]{\CompanyLogo}
                } &
