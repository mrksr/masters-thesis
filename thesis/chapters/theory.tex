...
This section first introduces \emph{Particle Swarm Optimization}, the gradient-free heuristic used in PSO-P to tackle the non-convex optimization problem of finding the optimal action sequence.
