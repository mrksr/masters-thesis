...
\begin{align}
    \Q(\mat{x}, \mat{y}) &\coloneqq \mat{K_{xM}} \mat{K_M}^{-1} \mat{K_{Mx}} \\
    \K_{\text{SPGP}}(\mat{x}, \mat{y}) &\coloneqq \Q(\mat{x}, \mat{y}) + \delta_{\mat{x}, \mat{y}} \left( \K(\mat{x}, \mat{y}) - \Q(\mat{x}, \mat{y}) \right)
\end{align}
