...
Every such element $x_i$ is normally distributed according to $x_i \sim \Gaussian{\mu_i, \Sigma_{ii}}$ with a particular dependency structure between them.
For every pair $x_i, x_j$, their covariance is given by $\Moment{\cov}{x_i, x_j} = \mat{\Sigma}_{ij}$.
