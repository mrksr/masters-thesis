...
In recent years, RL has successfully been used to control cars in autonomous driving \cite{kolter_probabilistic_2010} and to control complex industrial systems such as wind or gas turbines \todo{get some citation?}\cite{siemens_citation} whose behaviour cannot be described analytically in full detail.
...
\Cref{cha:theory} introduces a mathematical formulation of the general RL problem and presents both Gaussian processes and the PSO-Policy.
