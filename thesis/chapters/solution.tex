...
\begin{figure}[t]
    ...
    \end{subfigure}
    \caption{MISSING: Data Set properties}
...
\begin{figure}[tp]
    ...
    \caption{MISSING: MAP results, M vs mean-mean-reward or goal-percentage}
...
\begin{figure}[tp]
    ...
    \caption{MISSING: OS and MAP results, M vs mean-mean-reward or goal-percentage}
...
\begin{figure}[p]
    ...
    \caption{MISSING: Multi-Step results, M vs mean-mean-reward or goal-percentage}
...
\begin{figure}[tp]
    \centering
    \includegraphics[height=.35\textheight]{ms_goal_percentage.png}
    \caption{MISSING: Overall results, M vs mean-mean-reward}
    \label{fig:results_mean_mean_reward}
\end{figure}
\begin{figure}[tp]
    \centering
    \includegraphics[height=.35\textheight]{ms_goal_percentage.png}
    \caption{MISSING: Overall results, M vs goal-percentage}
