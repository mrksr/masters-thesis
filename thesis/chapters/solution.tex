...
\begin{figure}[tp]
    ...
    \begin{subfigure}{\subfigurewidth}
        \missingfigure[figheight=.25\textheight]{Length of Episodes}
        \caption{Length of Episodes}
        \label{fig:data_set_properties:episode_length}
    \end{subfigure}
    \begin{subfigure}{\subfigurewidth}
        \missingfigure[figheight=.25\textheight]{Omega histogram}
        \caption{Omega histogram}
        \label{fig:data_set_properties:omega_histogram}
    \end{subfigure}
...
\begin{figure}[tp]
    \centering
    \missingfigure[figheight=.4\textheight]{Positional Plot of a few Episodes}
