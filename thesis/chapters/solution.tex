...
\begin{figure}[t]
    \centering
    \missingfigure[figheight=.55\textheight]{MAP predictions}
...
\begin{figure}[tp]
    \centering
    \missingfigure[figheight=.35\textheight]{OS results}
...
\begin{figure}[p]
    \centering
    \missingfigure[figheight=.8\textheight]{OS trajectories}
...
\begin{figure}[t]
    \centering
    \missingfigure[figheight=.55\textheight]{Multi-Step predictions}
...
\begin{figure}[t]
    \centering
    \missingfigure[figheight=.55\textheight]{Multi-Step predictions with truncation}
